        ...
        <div>
          ...
          {isOwner ? (
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
              ...
              {isAuthenticated ? (
                <Link to={`/chat/${listing.user?._id}?listing=${listing._id}`} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', padding: '14px', background: '#0ea5e9', color: 'white', borderRadius: '8px', fontSize: '16px', fontWeight: '600', textDecoration: 'none' }}>
                  💬 In-App Chat
                </Link>
              ) : (
                <Link to="/login" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', padding: '14px', background: '#0ea5e9', color: 'white', borderRadius: '8px', fontSize: '16px', fontWeight: '600', textDecoration: 'none' }}>
                  Login to Chat
                </Link>
              )}
            </div>
